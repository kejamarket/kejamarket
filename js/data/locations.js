...
const NAIROBI_REGIONS = [
  ...
  },
  {
    ...
    suburbs: [
      { name: 'Dandora Phase 1', lat: -1.2520, lng: 36.8970, zone: 'Eastlands' },
      { name: 'Dandora Phase 2', lat: -1.2530, lng: 36.8980, zone: 'Eastlands' },
      { name: 'Dandora Phase 3', lat: -1.2550, lng: 36.9010, zone: 'Eastlands' },
      { name: 'Dandora Phase 4', lat: -1.2570, lng: 36.9030, zone: 'Eastlands' },
      { name: 'Dandora Phase 5', lat: -1.2580, lng: 36.9050, zone: 'Eastlands' },
      { name: 'Buruburu Phase 1', lat: -1.2900, lng: 36.8770, zone: 'Eastlands' },
      { name: 'Buruburu Phase 2', lat: -1.2910, lng: 36.8780, zone: 'Eastlands' },
      { name: 'Buruburu Phase 3', lat: -1.2920, lng: 36.8790, zone: 'Eastlands' },
      { name: 'Buruburu Phase 4', lat: -1.2930, lng: 36.8800, zone: 'Eastlands' },
      { name: 'Buruburu Phase 5', lat: -1.2940, lng: 36.8810, zone: 'Eastlands' },
      { name: 'Donholm Phase 1 & 2', lat: -1.3000, lng: 36.8850, zone: 'Eastlands' },
      { name: 'Donholm Phase 3, 4 & 5', lat: -1.3015, lng: 36.8870, zone: 'Eastlands' },
      { name: 'Donholm Phase 6, 7 & 8', lat: -1.3030, lng: 36.8890, zone: 'Eastlands' },
      { name: 'Greenfields Estate (Donholm)', lat: -1.3020, lng: 36.8880, zone: 'Eastlands' },
      { name: 'Greenspan Estate (Donholm)', lat: -1.3040, lng: 36.8910, zone: 'Eastlands' },
      ...
      { name: 'Nyayo Estate Gate A (Phase 1 & 2)', lat: -1.3140, lng: 36.9110, zone: 'Eastlands' },
      { name: 'Nyayo Estate Gate D (Phase 3, 4 & 5)', lat: -1.3160, lng: 36.9130, zone: 'Eastlands' },
      { name: 'Nyayo Estate Embakasi', lat: -1.3150, lng: 36.9120, zone: 'Eastlands' },
  ...
  },
  {
    ...
    suburbs: [
      ...
      { name: 'Mlolongo Phase 1', lat: -1.3820, lng: 36.9580, zone: 'Mombasa Road' },
      { name: 'Mlolongo Phase 2', lat: -1.3835, lng: 36.9605, zone: 'Mombasa Road' },
      { name: 'Mlolongo Phase 3 (Weighbridge, Expressway End)', lat: -1.3850, lng: 36.9620, zone: 'Mombasa Road' },
      { name: 'Mlolongo Phase 4', lat: -1.3870, lng: 36.9640, zone: 'Mombasa Road' },
      { name: 'Mlolongo Town', lat: -1.3830, lng: 36.9600, zone: 'Mombasa Road' },
      { name: 'Greatwall Gardens Phase 1 (Mlolongo)', lat: -1.3880, lng: 36.9700, zone: 'Mombasa Road' },
      { name: 'Greatwall Gardens Phase 2 (Mlolongo)', lat: -1.3885, lng: 36.9710, zone: 'Mombasa Road' },
      { name: 'Greatwall Gardens Phase 3 (Mlolongo)', lat: -1.3890, lng: 36.9720, zone: 'Mombasa Road' },
      { name: 'Greatwall Gardens Phase 4 (Mlolongo)', lat: -1.3895, lng: 36.9730, zone: 'Mombasa Road' },
      { name: 'Greatwall Gardens Phase 5 (Mlolongo)', lat: -1.3900, lng: 36.9740, zone: 'Mombasa Road' },
